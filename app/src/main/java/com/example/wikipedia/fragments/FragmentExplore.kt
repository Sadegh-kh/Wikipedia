...
import com.example.wikipedia.adpter.ExploreAdapter
import com.example.wikipedia.adpter.ItemEvents
import com.example.wikipedia.data.ItemPost
import com.example.wikipedia.databinding.FragmentExploreBinding

const val SEND_DATA_TO_SECOND_ACTIVITY ="data"
class FragmentExplore:Fragment(),ItemEvents {
    ...
    override fun onItemClick(itemPost: ItemPost) {
